...
<head>
  ...
  <title>Sign Up Form</title>
   <form class="d-flex justify-content-around" action="Updatesignup.php" method="POST">
...
<center>
  <h4>Need to Login? <span><a name = "login" class="btn btn-default signup" href="login.html">Login</a></span></h4>
<center>
